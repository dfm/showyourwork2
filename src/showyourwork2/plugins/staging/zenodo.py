...
from showyourwork2.paths import PathLike, package_data, path_to_identifier
from showyourwork2.plugins.staging.stages import Stage
...
class ZenodoStage(Stage):
    ...
    def snakefile(self) -> Path:
        return package_data(
            "showyourwork2.plugins.staging", "workflow", "rules", "zenodo.smk"
        )
