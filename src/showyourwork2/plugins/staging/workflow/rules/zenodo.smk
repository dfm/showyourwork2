...
for name, stage in stages.STAGES.items():
    ...
    if stage.restore:
        for file in stage.files.values():
            rule:
                name:
                    sywplug_staging__rule_name("zenodo", name, "download", document=file)
                message:
        ...
        rule:
            name:
                sywplug_staging__rule_name("zenodo", name, "draft")
            message:
        ...
        for file in stage.files.values():
            rule:
                name:
                    sywplug_staging__rule_name("zenodo", name, "upload", document=file)
                message:
        ...
        rule:
            name:
                sywplug_staging__rule_name("zenodo", name, "publish")
            message:
